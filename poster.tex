...
\begin{column}{\colwidth}
  ...
  \begin{block}{TCPLS Handshake}
    ...
    \begin{figure}
      \centering
      \includesvg[width=0.5\textwidth]{tcpls_hs}  % Without the .svg extension
  ...
  \begin{block}{TCPLS Record}
    ...
    \begin{figure}
      \centering
      \includesvg[width=0.5\textwidth]{tcpls_record}  % Without the .svg extension
  ...
  \begin{block}{TCPLS Transport Services}
    ...
    \begin{itemize}
      \item \textbf{Stream Multiplexing} Sent the data of a single stream over multiple connections or multiple
      streams over a single connection.
      \item \textbf{Connection Migration} The application can choose which TCP connection to send over.
      \item \textbf{Multipath} Aggregate the bandwidth of multiple TCP connections to achieve higher throughput.
    \end{itemize}
  \end{block}
